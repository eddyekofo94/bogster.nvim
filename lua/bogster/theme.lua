...
function M.setup(config)
  ...
  theme.base = {
    ...
    StatusLineNC = { fg = c.fg0, bg = c.bg_statusline }, -- status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    TabLine = { bg = c.bg_statusline, fg = c.fg0 }, -- tab pages line, not active tab page label
    ...
    String = { fg = c.light_green }, --   a string constant: "this is a string"
    Character = { fg = c.green }, --  a character constant: 'c', '\n'
    -- Number        = { }, --   a number constant: 234, 0xff
    -- Boolean       = { }, --  a boolean constant: TRUE, false
    -- Float         = { }, --    a floating point constant: 2.3e10

    Identifier = { fg = c.pink, style = config.variableStyle }, -- (preferred) any variable name
    Function = { fg = c.light_blue, style = config.functionStyle }, -- function name (also: methods for classes)

    Statement = { fg = c.pink }, -- (preferred) any statement
    -- Conditional   = { }, --  if, then, else, endif, switch, etc.
    -- Repeat        = { }, --   for, do, while, etc.
    -- Label         = { }, --    case, default, etc.
    Operator = { fg = c.base6 }, -- "sizeof", "+", "*", etc.
    Keyword = { fg = c.teal, style = config.keywordStyle }, --  any other keyword
    -- Exception     = { }, --  try, catch, throw

    PreProc = { fg = c.teal }, -- (preferred) generic Preprocessor
    ...
    -- documentation.
    LspReferenceText = { bg = c.fg0 }, -- used for highlighting "text" references
    LspReferenceRead = { bg = c.fg0 }, -- used for highlighting "read" references
    LspReferenceWrite = { bg = c.fg0 }, -- used for highlighting "write" references
  ...
  theme.plugins = {
    ...
    TSKeyword = { fg = c.pink, style = config.keywordStyle }, -- For keywords that don't fall in previous categories.
    ...
    LspTroubleCount = { fg = c.pink, bg = c.fg0 },
    LspTroubleNormal = { fg = c.fg_sidebar, bg = c.bg_sidebar },

    -- Illuminate
    illuminatedWord = { bg = c.fg0 },
    illuminatedCurWord = { bg = c.fg0 },
    ...
    NeogitHunkHeaderHighlight = { bg = c.fg0, fg = c.blue },
    NeogitDiffContextHighlight = { bg = util.darken(c.fg0, 0.5), fg = c.fg0 },
    ...
    LspSagaCodeActionTitle = { fg = c.base2 },
